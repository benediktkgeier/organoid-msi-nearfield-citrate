...
> This repo is code + docs + small inputs; the intermediate cache and figures are **regenerated by the
> pipeline** from that raw data — downloading the imzML is sufficient (see
> [`REPRODUCE.md`](REPRODUCE.md#data-availability)).
