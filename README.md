...
>
> **Data availability:** this repo is code + docs + small inputs; the cache, raw data, and rendered
> figures live in a separate data deposit — **link to be added** (see [`REPRODUCE.md`](REPRODUCE.md#data-availability)).
